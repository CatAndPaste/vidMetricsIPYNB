...
parser = argparse.ArgumentParser(description='PyVHR module')
parser.add_argument('video_file', type=str, help='Video File path')
parser.add_argument('roi_approach', type=str, help='ROI Approach')
parser.add_argument('bpm_est', type=str, help='BPM EST Approach')
parser.add_argument('method', type=str, help='Method')
parser.add_argument('estimator_index', type=int, help='Estimator index')
parser.add_argument('output_dir', type=str, help='Output dir')

args = parser.parse_args()

process_video_with_pyvhr(
    video_file=args.video_file,
    roi_approach=args.roi_approach,
    bpm_est=args.bpm_est,
    method=args.method,
